...
| [Excel Integration](https://www.telerik.com/blazor-ui/documentation/integrations/document-processing-libraries) | disabled | Some [Grid](https://www.telerik.com/blazor-ui/documentation/knowledge-base/grid-custom-cell-formatting-with-radspreadprocessing) or [Spreadsheet](https://www.telerik.com/blazor-ui/documentation/knowledge-base/spreadsheet-get-cell-values) scenarios may require creation or editing of Excel files with Telerik Document Processing. This option references the required NuGet packages. |
